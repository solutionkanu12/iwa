...
pub const CURE_NOT_ELIGIBLE: felt252 = 'IWA: cure not eligible';
...
pub const NOT_SETTLEMENT_HELPER: felt252 = 'IWA: helper only';
pub const HELPER_NOT_INITIALIZED: felt252 = 'IWA: helper unset';
pub const HELPER_ALREADY_INITIALIZED: felt252 = 'IWA: helper initialized';
pub const INVALID_OPEN_NOTE: felt252 = 'IWA: invalid open note';
pub const RECOVERY_NOT_READY: felt252 = 'IWA: recovery not ready';
pub const RECOVERY_NONCE_USED: felt252 = 'IWA: recovery nonce used';
pub const RECOVERY_ALREADY_PREPARED: felt252 = 'IWA: recovery prepared';
pub const LIABILITY_INVARIANT: felt252 = 'IWA: liability invariant';
