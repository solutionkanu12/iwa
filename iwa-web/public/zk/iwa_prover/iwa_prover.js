 ...
 * @returns {string}
 */
function prove(zkey, witness_json) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @param {string} vk_json
 * @param {string} result_json
 * @returns {boolean}
 */
function verify(vk_json, result_json) {
    const ptr0 = passStringToWasm0(vk_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
//#region wasm loading
const wasmPath = `${__dirname}/iwa_prover_bg.wasm`;
