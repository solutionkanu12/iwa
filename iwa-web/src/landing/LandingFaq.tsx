...
const FAQS = [
  {
    ...
    a: "A savings circle, or ajo, is a group who each put in a fixed amount every round and take turns collecting the whole pot. Iwa handles the turns and payments for you.",
  },
  {
    q: "Do I need a bank account",
    a: "No. You need a compatible wallet and a phone. Iwa is built for people the banks cannot see, so a bank account is never the starting point.",
  },
  {
  ...
  },
  {
    ...
    a: "Contributions and payouts run through smart contracts, so no single person holds the pot. Contributions are private: the amounts and who paid them are hidden, while your good standing stays provable.",
  },
  {
