...
// GitHub icon links (placeholder hrefs), and a large faded "iwa" wordmark
// behind. Column headings and labels are exact from design/iwa-prototype.html.
// This is the one reveal-once group (no replay). Nav, hero, and earlier
// sections, app, app nav, and seams are untouched.

const COLUMNS: { heading: string; links: string[] }[] = [
  { heading: "product", links: ["How it works", "Roadmap", "Enter the circle"] },
  { heading: "resources", links: ["Docs", "Guides", "Litepaper", "GitHub"] },
  { heading: "built on", links: ["Stellar", "Soroban", "Zero-knowledge proofs"] },
  {
    heading: "company",
    links: ["About Iwa", "Privacy policy", "Terms of service"],
  },
];
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.bottom}>
          <div className={styles.social}>
            <a className={styles.socialLink} href="#" aria-label="Iwa on X">
              <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a className={styles.socialLink} href="#" aria-label="Iwa on GitHub">
