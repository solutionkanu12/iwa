...
export declare abstract class AbstractPrivateTransfers implements PrivateTransfersInterface {
    ...
    protected readonly shadowAccountAnonymizerAddress?: StarknetAddress | undefined;
    ...
    constructor(userAddress: StarknetAddress, viewingKeyProvider: ViewingKeyProvider, discoveryProvider: DiscoveryProviderInterface, shadowAccountAnonymizerAddress?: StarknetAddress | undefined);
    /**
