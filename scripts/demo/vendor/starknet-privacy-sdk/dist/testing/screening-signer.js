...
const DEPOSITOR_VALIDATION_TYPE_HASH = 0x32d43b7372c9ea8a35daf12b02c5f6f74837910ecbaf2a3ecfe71fec901913dn;
...
export const SCREENING_SIGNER_PUBLIC_KEY = BigInt(ec.starkCurve.getStarkKey(SCREENING_SIGNER_PRIVATE_KEY));
/**
 ...
 */
export function computeScreeningMessageHash(chainId, depositor, issuedAt, signerPublicKey) {
 ...
 */
export function signScreeningAttestation(privateKey, chainId, depositor, issuedAt) {
    const signerPublicKey = BigInt(ec.starkCurve.getStarkKey(privateKey));
    const messageHash = computeScreeningMessageHash(chainId, depositor, BigInt(issuedAt), signerPublicKey);
...
//# sourceMappingURL=screening-signer.js.map