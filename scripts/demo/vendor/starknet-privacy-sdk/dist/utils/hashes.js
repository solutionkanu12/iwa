...
export function compute_identity_key(user_addr, user_private_key, contract_address) {
    return hash(IDENTITY_KEY_TAG, user_addr, user_private_key, contract_address);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_enc_private_key_hash(shared_x) {
    return hash(ENC_PRIVATE_KEY_TAG, shared_x);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_enc_user_addr_hash(shared_x) {
    return hash(ENC_USER_ADDR_TAG, shared_x);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_enc_token_hash(channel_key, index, salt) {
    return hash(ENC_TOKEN_TAG, channel_key, index, 0n, salt);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_enc_channel_key_hash(shared_x) {
    return hash(ENC_CHANNEL_KEY_TAG, shared_x);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_enc_sender_addr_hash(shared_x) {
    return hash(ENC_SENDER_ADDR_TAG, shared_x);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_enc_recipient_addr_hash(sender_addr, sender_private_key, index, salt) {
    return hash(ENC_RECIPIENT_ADDR_TAG, sender_addr, sender_private_key, index, 0n, salt);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_channel_key(sender_addr, sender_private_key, recipient_addr, recipient_public_key) {
    return hash(CHANNEL_KEY_TAG, sender_addr, sender_private_key, recipient_addr, recipient_public_key);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_outgoing_channel_id(sender_addr, sender_private_key, index) {
    return hash(OUTGOING_CHANNEL_ID_TAG, sender_addr, sender_private_key, index, 0n);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_channel_marker(channel_key, sender_addr, recipient_addr, recipient_public_key) {
    return hash(CHANNEL_MARKER_TAG, channel_key, sender_addr, recipient_addr, recipient_public_key);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_subchannel_id(channel_key, index) {
    return hash(SUBCHANNEL_ID_TAG, channel_key, index, 0n);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_subchannel_marker(channel_key, recipient_addr, recipient_public_key, token) {
    return hash(SUBCHANNEL_MARKER_TAG, channel_key, recipient_addr, recipient_public_key, token);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_note_id(channel_key, token, index) {
    return hash(NOTE_ID_TAG, channel_key, token, index, 0n);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_enc_amount_hash(channel_key, token, index, salt) {
    return hash(ENC_AMOUNT_TAG, channel_key, token, index, 0n, salt);
}
/** See packages/privacy/src/hashes.cairo for documentation. */
export function compute_nullifier(channel_key, token, index, owner_private_key) {
